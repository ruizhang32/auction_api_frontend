...
export function calcCategory(categoryList: Array<string>): number {
  ...
  categoryList.forEach(
    (category) => (result += Math.pow(2, parseInt(category) - 1))
  );
  return result;
}

export function getCategoryNamesByIds(
...
export function getCategoryIdsByNames(
  categoryNameLists: Array<string>,
  categoryIdName: Array<Category>
): Array<string> {
  let result: Array<string> = [];
...
export const defaultUserImageUrl: string =
  "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.kindpng.com%2Fimgv%2Fiwoxbb_user-profile-default-image-png-clipart-png-download%2F&psig=AOvVaw1LfCjvvEuN_yKv2tgeS9v1&ust=1653961417394000&source=images&cd=vfe&ved=https://www.pngitem.com/middle/mmhwxw_transparent-user-png-default-user-image-png-png/";
